import { View, Text, Switch, Image, TouchableOpacity, ScrollView, SafeAreaView } from "react-native";
        ...
        <ScrollView>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerImage}>
              ...
              <Image style={styles.headerImageDetail} resizeMode='contain' source={require('../../../assets/img/accounts/anhNenAccount.png')} />
            ...
            <View style={styles.headerText}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('EditInfo')}>
                <View style={styles.headerTextEdit}>
                  <Text style={styles.headerTextEditText}>Chỉnh sửa thông tin cá nhân</Text>
                </View>
              </TouchableOpacity>
            </View>
